...
| <img src="img/probes/37_car.jpg" width="440"><br><b>37_car</b> — машина: четыре луча, перенос веса, круг трения<br><sub><a href="probes/37_car/README.md">заметка</a> · эталон: GTA, Halo</sub> | <img src="img/probes/38_tyre.jpg" width="440"><br><b>38_tyre</b> — шина: проскальзывание, нагрузка, дифференциал<br><sub><a href="probes/38_tyre/NOTES.md">заметка</a> · эталон: Gran Turismo</sub> |
