...
| <img src="img/probes/27_crowd.jpg" width="440"><br><b>27_crowd</b> — толпа: расступание<br><sub><a href="probes/27_crowd/README.md">заметка</a> · эталон: RTS, MMO</sub> | <img src="img/probes/28_phys.jpg" width="440"><br><b>28_phys</b> — физика: тела, сочленения, повторяемость<br><sub><a href="probes/28_phys/README.md">заметка</a></sub> |
| <img src="img/probes/29_day.jpg" width="440"><br><b>29_day</b> — небо и время суток<br><sub><a href="probes/29_day/README.md">заметка</a></sub> | <img src="img/probes/30_gun.jpg" width="440"><br><b>30_gun</b> — стрельба: выстрел как аккорд<br><sub><a href="probes/30_gun/README.md">заметка</a> · эталон: FEAR, DOOM</sub> |
| <img src="img/probes/31_sound.jpg" width="440"><br><b>31_sound</b> — звук как информация<br><sub><a href="probes/31_sound/README.md">заметка</a></sub> | <img src="img/probes/32_move.jpg" width="440"><br><b>32_move</b> — акробатика от первого лица<br><sub><a href="probes/32_move/README.md">заметка</a> · эталон: Titanfall, Mirror's Edge</sub> |
| <img src="img/probes/33_land.jpg" width="440"><br><b>33_land</b> — рельеф как источник импульса<br><sub><a href="probes/33_land/README.md">заметка</a> · эталон: Tribes</sub> | <img src="img/probes/34_scale.jpg" width="440"><br><b>34_scale</b> — масштаб: как держать мир, который больше экрана<br><sub><a href="probes/34_scale/README.md">заметка</a></sub> |
| <img src="img/probes/35_detail.jpg" width="440"><br><b>35_detail</b> — детализация поверхности<br><sub><a href="probes/35_detail/README.md">заметка</a></sub> | <img src="img/probes/36_forest.jpg" width="440"><br><b>36_forest</b> — лоу-поли лес<br><sub><a href="probes/36_forest/README.md">заметка</a></sub> |
| <img src="img/probes/37_car.jpg" width="440"><br><b>37_car</b> — машина: четыре луча, перенос веса, круг трения<br><sub><a href="probes/37_car/README.md">заметка</a> · эталон: GTA, Halo</sub> | <img src="img/probes/38_tyre.jpg" width="440"><br><b>38_tyre</b> — шина: проскальзывание, нагрузка, дифференциал<br><sub><a href="probes/38_tyre/README.md">заметка</a> · эталон: Gran Turismo</sub> |
| <img src="img/probes/40_hit.jpg" width="440"><br><b>40_hit</b> — попадание: импульс, рычаг, разрушение<br><sub><a href="probes/40_hit/README.md">заметка</a> · эталон: Half-Life 2</sub> | <img src="img/probes/41_ruin.jpg" width="440"><br><b>41_ruin</b> — конструкция: связи, порог, обрушение<br><sub><a href="probes/41_ruin/README.md">заметка</a> · эталон: Red Faction</sub> |
| <img src="img/probes/42_voronoi.jpg" width="440"><br><b>42_voronoi</b> — скол: ячейки Вороного, куски складываются в целое<br><sub><a href="probes/42_voronoi/README.md">заметка</a> · эталон: Red Faction Guerrilla</sub> | <img src="img/probes/43_stuff.jpg" width="440"><br><b>43_stuff</b> — материал: прочность против вязкости, узор ломания<br><sub><a href="probes/43_stuff/README.md">заметка</a> · эталон: Red Faction Guerrilla</sub> |
| <img src="img/probes/44_missile.jpg" width="440"><br><b>44_missile</b> — ракета как аппарат: тяга, сопротивление, рули<br><sub><a href="probes/44_missile/README.md">заметка</a> · эталон: ArmA, DCS</sub> | <img src="img/probes/45_seeker.jpg" width="440"><br><b>45_seeker</b> — головка наведения: захват, сближение, срыв<br><sub><a href="probes/45_seeker/README.md">заметка</a> · эталон: DCS, Ace Combat</sub> |
| <img src="img/probes/46_rocket.jpg" width="440"><br><b>46_rocket</b> — ракета-носитель: тяга, устойчивость, ступени<br><sub><a href="probes/46_rocket/README.md">заметка</a> · эталон: Kerbal Space Program</sub> | <img src="img/probes/47_shoulder.jpg" width="440"><br><b>47_shoulder</b> — пуск с плеча: струя назад, взведение, ведение цели рукой<br><sub><a href="probes/47_shoulder/README.md">заметка</a> · эталон: ArmA · не закрыта</sub> |
