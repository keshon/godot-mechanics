...
| <img src="img/probes/23_fft.jpg" width="440"><br><b>23_fft</b> — два океана под одним небом<br><sub><a href="probes/23_fft/README.md">заметка</a> · эталон: Sea of Thieves</sub> | <img src="img/probes/24_knobs.jpg" width="440"><br><b>24_knobs</b> — ручки, собранные из самого шейдера<br><sub><a href="probes/24_knobs/NOTES.md">заметка</a> · эталон: инструмент</sub> |
